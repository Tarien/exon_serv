...
addTravelKeyword('darashia', 80, Position(33267, 32441, 6))
-- addTravelKeyword('vanguard', 80, Position(33369, 32954, 4))

npcHandler:setMessage(MESSAGE_GREET, 'Vanguard\'s blessings, traveller |PLAYERNAME|.')
npcHandler:setMessage(MESSAGE_FAREWELL, 'It was a pleasure to help you, |PLAYERNAME|.')
npcHandler:setMessage(MESSAGE_WALKAWAY, 'HEY! |PLAYERNAME|! RUB MY LAMP!.')
