...
-- Basic
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = 'My name is Captain Auras, I play it safe.'})
...
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to go to {Vanguard}?'})
...
keywordHandler:addKeyword({'darashia'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'carlin'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'ab\'dendriel'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'edron'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'venore'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'port hope'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'roshamuul'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'svargrond'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'liberty bay'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'yalahar'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'oramond'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'krailos'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
keywordHandler:addKeyword({'thais'}, StdModule.say, {npcHandler = npcHandler, text = 'I only sail to Haven.'})
...
npcHandler:setMessage(MESSAGE_GREET, 'Hello, |PLAYERNAME|. Where can I {sail} you today?')
