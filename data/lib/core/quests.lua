		...
		[12] = {
			...
			missions = {
				...
				[37] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/15 Goblins.",
				...
				[38] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/500 Minotaurs.",
				...
				[39] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/400 Necromancers and Priestess.",
				...
				[40] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 crocodiles.",
				...
				[41] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 badgers.",
				...
				[42] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 tarantulas.",
				...
				[43] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/15 carniphilas.",
				...
				[44] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/20 stone golems.",
				...
				[45] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 mammoths.",
				...
				[46] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 gnarlhounds.",
				...
				[47] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 terramites.",
				...
				[48] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 apes.",
				...
				[49] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 thornback tortoises.",
				...
				[50] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 gargoyles.",
				...
				[51] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 ice golems.",
				...
				[52] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 quara scouts.",
				...
				[53] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 mutated rats.",
				...
				[54] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/25 ancient scarabs.",
				...
				[55] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 wyverns.",
				...
				[56] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 lancer beetles.",
				...
				[57] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 wailing widows.",
				...
				[58] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/25 killer caimans.",
				...
				[59] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 bonebeasts.",
				...
				[60] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 crystal spiders.",
				...
				[61] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 mutated tigers.",
				...
				[62] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/60 underwater quara.",
				...
				[63] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 giant spiders.",
				...
				[64] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/30 werewolves.",
				...
				[65] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 nightmares.",
				...
				[66] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/60 hellspawns.",
				...
				[67] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/80 high class lizards.",
				...
				[68] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/60 stampors.",
				...
				[69] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 brimstone bugs.",
				...
				[70] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 mutated bats.",
				...
				[71] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/65 hydras.",
				...
				[72] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/80 serpent spawns.",
				...
				[73] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 medusas.",
				...
				[74] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/70 behemoths.",
				...
				[75] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/90 sea serpents and young sea serpents.",
				...
				[76] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/25 hellhounds.",
				...
				[77] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 ghastly dragons.",
				...
				[78] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/90 drakens.",
				...
				[79] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/65 destroyers.",
				...
				[80] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/40 undead dragons.",
				...
				[81] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/666 demons.",
				...
				[82] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 green djinns or efreets.",
				...
				[83] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/50 blue djinns or marids.",
				...
				[84] = {
					...
					description =
					function(player)
						return string.format("You already hunted %d/300 pirates.",
				...
				[86] = {
					...
					description =
					function(player)
						return string.format("Budrik asked you to kill 500 minotaurs for him. You already killed %d minotaurs.",
